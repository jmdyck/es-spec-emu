...
ad_hoc_xlink_info = [
    ...
    ('sec-ecmascript-function-objects', 'ECMAScript function object'),
    ('sec-ecmascript-language-types', 'ECMAScript language type'),
    ('sec-ecmascript-language-types', 'ECMAScript language value'),
    ('sec-ecmascript-language-types', 'ECMAScript language values'),
    ('sec-environment-records', 'Environment Record'),
    ...
    ('sec-list-and-record-specification-type', 'List'),
    ('sec-local-time-zone-adjustment', 'LocalTZA'),
